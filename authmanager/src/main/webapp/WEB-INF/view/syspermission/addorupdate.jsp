		...
		<div class="text-center page-header text-primary">
			...
			<form class="form-horizontal" role="form" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="hidden" class="form-control" id="menuidlist"
							name="menuidlist" value="${record.menuidlist}"> <label id="menunamelist"></label>
						<div id="selectmedal">
							<input type="button" class="btn btn-primary" value="选择列表"
								onclick="selectload('loadselectdatamenu','sysmenu','checkbox','menuidlist','menunamelist');" />
							<div id="loadselectdatamenu"></div>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="parentid" class="col-sm-2 control-label">所属功能</label>
					<div class="col-sm-10">
						<input type="hidden" class="form-control" id="actionidlist"
							name="actionidlist" value="${record.actionidlist}"> <label id="actionnamelist"></label>
						<div id="selectmedal">
							<input type="button" class="btn btn-primary" value="选择列表"
								onclick="selectload('loadselectdataaction','sysaction','checkbox','actionidlist','actionnamelist');" />
							<div id="loadselectdataaction"></div>
						</div>
					</div>
				</div>
				<div class="form-group">
