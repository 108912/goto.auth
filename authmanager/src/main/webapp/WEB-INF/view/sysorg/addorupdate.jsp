		...
		<div class="text-center page-header text-primary">
			...
			<form class="form-horizontal" role="form" method="post"
				...
				<div class="form-group">
					<label for="parentid" class="col-sm-2 control-label">所属权限</label>
					<div class="col-sm-10">
						<input type="hidden" class="form-control" id="permissionidlist"
							name="permissionidlist" value="${record.permissionidlist}"> <label id="permissionnamelist"></label>
						<div id="selectmedal">
							<input type="button" class="btn btn-primary" value="选择列表"
								onclick="selectload('loadselectdatapermission','syspermission','checkbox','permissionidlist','permissionnamelist');" />
							<div id="loadselectdatapermission"></div>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="hidden" class="form-control" id="parentid"
							name="parentid" value="${record.parentid}"> <label id="orgname"></label>
						<div id="selectmedal">
							<input type="button" class="btn btn-primary" value="选择列表"
								onclick="selectload('loadselectdata','sysorg','radio','parentid','orgname');" />
							<div id="loadselectdata"></div>
						</div>
					</div>
				</div>
				<div class="form-group">
