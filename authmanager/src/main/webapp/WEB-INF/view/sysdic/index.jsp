			...
			<form class="form-horizontal" role="form" method="get" action="index">
				...
				<div class="text-right">
					...
					<a class="btn btn-info"
						href="${pageContext.request.contextPath }/sysdic/addorupdate?id=0">添加</a>
				</div>
			</form>
					...
					<c:forEach var="item" items="${datalist}">
						<tr>
							...
							<td><a class="btn btn-default"
								href="${pageContext.request.contextPath }/sysdic/addorupdate?id=${item.id}">编辑</a>
								<a class="btn btn-danger"
								href="${pageContext.request.contextPath }/sysdic/del?id=${item.id}">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
