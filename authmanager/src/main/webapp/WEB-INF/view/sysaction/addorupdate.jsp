				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="hidden" class="form-control" id="projectid"
							name="projectid" value="${record.projectid}"> <label
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="hidden" class="form-control" id="menuid"
							name="menuid" value="${record.menuid}"> <label
							id="menuname"></label>
						<div id="selectmedal">
							<input type="button" class="btn btn-primary" value="选择列表"
								onclick="selectload('loadselectdatamenu','sysmenu','radio','menuid','menuname');" />
